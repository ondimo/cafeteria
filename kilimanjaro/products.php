<?php
    ...
    if (isset($_GET['delete'])){
        ...
        $delete_query = mysqli_query($conn, "DELETE FROM products_kilimanjaro where id=$delete_id") or die('query failed');
        if($delete_query){
    ...
    if(isset($_POST['update_product'])){
        ...
        $update_query = mysqli_query($conn, "UPDATE products_kilimanjaro SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = $update_p_id");
...
<body>
    ...
    <div class="containeer">
        <section class="display-product-table">
            <table>
                ...
                <tbody>
                    <?php
                    $select_products = mysqli_query($conn, "SELECT * FROM products_kilimanjaro");
    ...
    <section class="edit-form-container">
        ...
        if (isset($_GET['edit'])){
            $edit_id = $_GET['edit'];
            $edit_query = mysqli_query($conn, "SELECT * FROM products_kilimanjaro WHERE id = $edit_id");
