...
if(isset($_POST['add_item'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO products_kilimanjaro (name, price, image) VALUES ('$p_name', '$p_price','$p_image')") or die('query failed');
...
<head>
   ...
   <title>Kilimanjaro Cafeteria Admin Panel</title>
