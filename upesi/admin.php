...
if(isset($_POST['add_item'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO products_upesi (name, price, image) VALUES ('$p_name', '$p_price','$p_image')") or die('query failed');
...
<head>
   ...
   <title>Upesi Joint Admin Panel</title>
